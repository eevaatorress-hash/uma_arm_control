    ...
    */
    ...
    public:
        DynamicsCancellationNode()
            : Node("dynamics_cancellation_node"),
              ...
              joint_accel_(Eigen::VectorXd::Zero(2))
        {
    ...
    private:
        // joint_states subscription callback - when a new message arrives, updates the dynamics cancellation and publishes teh joint_accel_
        ...
        {
            // publish joint accel
            auto joint_accel_msg = std_msgs::msg::Float64MultiArray();
            joint_accel_msg.data.assign(joint_accel_.data(), joint_accel_.data() + joint_accel_.size());
            publisher_joint_accel_->publish(joint_accel_msg);
        }
        ...
        rclcpp::Publisher<std_msgs::msg::Float64MultiArray>::SharedPtr publisher_joint_accel_;
